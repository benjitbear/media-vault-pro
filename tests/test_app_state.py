...
class TestAppState:
    ...
    def test_update_media_metadata(self, app_state):
        ...
        success = app_state.update_media_metadata('update1', {
            'title': 'New Title',
            'year': '2025',
            'rating': 8.5,
        })
    ...
    def test_job_queue_ordering(self, app_state):
        ...
        id2 = app_state.create_job('Second', '/vol/2')
    ...
    def test_update_collection_with_items(self, app_state):
        ...
        for mid in ['m1', 'm2', 'm3']:
            app_state.upsert_media({
                'id': mid, 'title': mid,
                'filename': f'{mid}.mp4', 'file_path': f'/tmp/{mid}.mp4',
            })
    ...
    def test_cleanup_expired_sessions(self, app_state):
        ...
        token = app_state.create_session(hours=0)  # expires immediately
