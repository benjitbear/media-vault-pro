...
class TestSearchTmdb:
    ...
    def test_successful_search(self, mock_get, client):
        ...
        detail_resp.json.return_value = {
            ...
            'vote_average': 8.7, 'poster_path': '/poster.jpg',
    ...
    def test_fallback_finds_result(self, mock_get, client):
        ...
        fallback_resp.json.return_value = {
            'results': [{'id': 100, 'title': 'Some Movie'}]
        }
        detail_resp = MagicMock()
        detail_resp.json.return_value = {
            'title': 'Some Movie', 'original_title': 'Some',
            'release_date': '2023-01-01', 'overview': '',
            'runtime': 90, 'genres': [], 'vote_average': 6.0,
        ...
        mock_get.side_effect = [
            empty_resp, fallback_resp, detail_resp, credits_resp
        ]
    ...
    def test_no_collection(self, mock_get, client):
        ...
        detail_resp = MagicMock()
        detail_resp.json.return_value = {
            'title': 'Solo', 'original_title': 'Solo',
            'release_date': '', 'overview': '', 'runtime': 100,
            'genres': [], 'vote_average': 5.0,
            'poster_path': None, 'backdrop_path': None,
            'belongs_to_collection': None,
        }
        credits_resp = MagicMock()
    ...
    def test_search_with_year(self, mock_get, client):
        ...
        detail_resp.json.return_value = {
            ...
            'release_date': '2020-06-15', 'overview': '',
            'runtime': 120, 'genres': [], 'vote_average': 7.0,
            'poster_path': None, 'backdrop_path': None,
            'belongs_to_collection': None,
        }
        credits_resp = MagicMock()
...
class TestPickBestTmdbMatch:
    ...
    def test_runtime_disambiguation(self, mock_get, client):
        ...
        best = client._pick_best_tmdb_match(
            results, {'estimated_runtime_min': 130}
        )
    ...
    def test_runtime_disambiguation_handles_fetch_error(self, mock_get, client):
        ...
        best = client._pick_best_tmdb_match(
            results, {'estimated_runtime_min': 120}
        )
        assert best == 1
