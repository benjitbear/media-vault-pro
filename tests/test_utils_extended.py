...
from src.utils import (
    detect_media_type, sanitize_filename, format_size, format_time,
    ensure_directory, natural_sort_key, load_config, get_media_root,
    get_data_dir, setup_logger, rename_with_metadata,
)
...
class TestRenameWithMetadata:
    ...
    def test_nonexistent_file(self, tmp_path):
        import logging
        logger = logging.getLogger('test')
        result = rename_with_metadata(
            str(tmp_path / 'nope.mp4'), {'title': 'X'}, logger
        )
