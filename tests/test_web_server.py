...
from src.web_server import MediaServer, generate_media_id
...
def server_config(tmp_path):
    ...
    media_dir.mkdir()
    return {
        "output": {"base_directory": str(media_dir), "format": "mp4",
        ...
        "web_server": {"enabled": True, "port": 8097, "host": "127.0.0.1",
                       "library_name": "Test"},
...
class TestSafeItems:
    def test_strips_sensitive_fields(self, noauth_client):
        ...
        items = [
            {'id': '1', 'title': 'Movie', 'file_path': '/secret/path.mp4',
             'poster_path': '/secret/poster.jpg', 'other': 'value'}
        ]
